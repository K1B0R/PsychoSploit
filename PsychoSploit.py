...
if main == '1':
    ...
    time.sleep(5)
    os.system('mkdir ~/Documents/Wordlist')
    os.system('curl https://gitlab.com/kalilinux/packages/wordlists/-/raw/kali/master/rockyou.txt.gz?inline=false -o ~/Documents/Wordlist/rockyou.txt.gz')
    time.sleep(3)
