...
if pwn == '1':
    ...
    print(Style.BRIGHT + Fore.CYAN + 'Make Sure You Are Running This Script As ROOT User! This Will Make A Folder In the /root/Desktop called tmp Will Be the OutPut Of Both "C" Reverse Shells in TxT Form')
    time.sleep(3)
    print(Style.BRIGHT + Fore.CYAN + 'Getting Things SetUp!......')
    time.sleep(3)
    os.mkdir('/root/Desktop/tmp/')
    os.system('cp ~/src/c.txt /root/Desktop/tmp/')
    time.sleep(5)
    os.system('python3 PsychoSploit.py')
elif pwn == '9':
    time.sleep(3)
    ...
    os.system('cp ~/src/Perl.txt /root/Desktop/tmp/')
    print(Style.BRIGHT + Fore.CYAN + 'Perl Reverse Shell Is In /root/Desktop/tmp/ !')
    time.sleep(5)
    os.system('python3 PsychoSploit.py')
elif pwn == '11':
    time.sleep(3)
    ...
    time.sleep(3)
    os.mkdir('/root/Desktop/tmp/')
    os.system('cp ~/src/PHP_Emoji.php /root/Desktop/tmp/')
    time.sleep(5)
    os.system('python3 PsychoSploit.py')
elif pwn == '12':
    print('Getting The File For You (REMEMBER THIS WILL OUTPUT TO /root/Desktop/tmp) !!!! AND RUN THIS SCRIPT AS ROOT!!!.....')
    time.sleep(3)
    os.system('cp ~/src/PentestMonkeyReverse.php /root/Desktop/tmp/')
    print('Done!')
    time.sleep(2)
    os.system('python3 PsychoSploit.py')
elif pwn == '13':
    print('Getting File Ready For You will be OutPuted In Your /root/Desktop/tmp....')
    time.sleep(2)
    os.system('cp ~/src/PHP.txt /root/Desktop/tmp/')
    time.sleep(1)
    print('Done!')
    os.system('python3 PsychoSploit.py')
elif pwn == '14':
    print('Getting File Ready For You will be OutPuted In Your /root/Desktop/tmp....')
    time.sleep(3)
    os.system('cp ~/src/PS1.txt /root/Desktop/tmp/')
    time.sleep(1)
    print('Done!')
    os.system('python3 PsychoSploit.py')
elif pwn == '15':
    print('Getting File Ready For You will be OutPuted In Your /root/Desktop/tmp....')
    time.sleep(2)
    os.system('cp ~/src/PS2.txt /root/Desktop/tmp')
    time.sleep(2)
    print('Done!')
    time.sleep(2)
    os.system('python3 PsychoSploit.py')
    ...
    print('Getting File Ready For You will be OutPuted In Your /root/Desktop/tmp....')
    time.sleep(2)
    os.system('cp ~/src/PS3.txt /root/Desktop/tmp')
    time.sleep(2)
    print('Done!')
    time.sleep(2)
    os.system('python3 PsychoSploit.py')
    ...
    print('Getting File Ready For You will be OutPuted In Your /root/Desktop/tmp....')
    time.sleep(2)
    os.system('cp ~/src/python1.txt /root/Desktop/tmp')
    time.sleep(2)
    print('Done!')
    time.sleep(2)
    os.system('python3 PsychoSploit.py')
    ...
    print('Getting File Ready For You will be OutPuted In Your /root/Desktop/tmp....')
    time.sleep(2)
    os.system('cp ~/src/python2.txt /root/Desktop/tmp')
    time.sleep(2)
    print('Done!')
    time.sleep(2)
    os.system('python3 PsychoSploit.py')
    ...
    print('Getting File Ready For You will be OutPuted In Your /root/Desktop/tmp....')
    time.sleep(2)
    os.system('cp ~/src/python3.txt /root/Desktop/tmp')
    time.sleep(2)
    print('Done!')
    time.sleep(2)
    os.system('python3 PsychoSploit.py')
    ...
    print('Getting File Ready For You will be OutPuted In Your /root/Desktop/tmp....')
    time.sleep(2)
    os.system('cp ~/src/node.js /root/Desktop/tmp')
    time.sleep(2)
    print('Done!')
    time.sleep(2)
    os.system('python3 PsychoSploit.py')
    ...
    print('Getting File Ready For You will be OutPuted In Your /root/Desktop/tmp....')
    time.sleep(2)
    os.system('cp ~/src/java.txt /root/Desktop/tmp')
    time.sleep(2)
    print('Done!')
    time.sleep(2)
    os.system('python3 PsychoSploit.py')
    ...
    print('Getting File Ready For You will be OutPuted In Your /root/Desktop/tmp....')
    time.sleep(2)
    os.system('cp ~/src/zsh.txt /root/Desktop/tmp')
    time.sleep(2)
    print('Done!')
    time.sleep(2)
    os.system('python3 PsychoSploit.py')
    ...
    print('Getting File Ready For You will be OutPuted In Your /root/Desktop/tmp....')
    time.sleep(2)
    os.system('cp ~/src/telnet.txt /root/Desktop/tmp')
    time.sleep(2)
    print('Done!')
    time.sleep(2)
    os.system('python3 PsychoSploit.py')
